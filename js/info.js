...
var points = 	[
					["#group-a", "Group A",
						...
						["Lebanon", "", "0"],
						["Holiday Club", "", "0"],
						["Gonzo Soccer Team", "", "0"], "group-a"],
					["#group-b", "Group B",
						["Inno Xi", "", "0"],
						["Korea", "", "0"],
						["The Italians", "", "0"],
						["Keggers Rock", "", "0"], "group-b"],
					["#group-c", "Group C",
						["Kellogg SC", "", "0"],
						["Massive Rec", "", "0"],
						["Trinidad & Tobago", "", "0"],
						["The Average Joes", "", "0"], "group-c"],
					["#group-d", "Group D",
						["Israel", "", "0"],
						["The Haroon Five", "", "0"],
						["Spoopy Soccer Players", "", "0"],
						["Mexico", "", "0"], "group-d"],
					// ["#group-e", "Group E",
					// 	["Mexico", "mx", "9"],
					// 	["Sao Tome", "st", "6"],
...
var groups = 	[
					["#group-a-f",
						[field1, "November 4, 12:00", "Shiverpool", "", "Lebanon", "", "- : -"],
						[field2, "November 4, 12:00", "Holiday Club", "", "Gonzo Soccer Team", "", "- : -"],
						[field1, "November 4, 12:30", "Shiverpool", "", "Holiday Club", "", "- : -"],
						[field2, "November 4, 12:30", "Lebanon", "", "Gonzo Soccer Team", "", "- : -"],
						[field1, "November 4, 1:30", "Shiverpool", "", "Gonzo Soccer Team", "", "- : -"],
						[field2, "November 4, 1:30", "Lebanon", "", "Holiday Club	", "", "- : -"]],
					["#group-b-f",
						[field3, "November 4, 12:00", "Inno XI", "", "Korea", "", "- : -"],
						[field4, "November 4, 12:00", "The Italians", "", "Keggers Rock", "", "- : -"],
						[field3, "November 4, 12:30", "Inno XI", "", "The Italians", "", "- : -"],
						[field4, "November 4, 12:30", "Korea", "", "Keggers Rock", "", "- : -"],
						[field3, "November 4, 1:30", "Inno XI", "", "Keggers Rock", "", "- : -"],
						[field4, "November 4, 1:30", "Korea", "", "The Italians", "", "- : -"]],
					["#group-c-f",
						[field5, "November 4, 12:30", "Kellogg SC", "", "Massive Rec", "", "- : -"],
						[field6, "November 4, 12:30", "Trinidad & Tobago", "", "The Averages Joes", "", "- : -"],
						[field1, "November 4, 1:00", "Kellogg SC", "", "Trinidad & Tobago", "", "- : -"],
						[field2, "November 4, 1:00", "Massive Rec", "", "The Average Joes", "", "- : -"],
						[field6, "November 4, 1:30", "Kellogg SC", "", "The Average Joes", "", "- : -"],
						[field6, "November 4, 2:00", "Massive Rec", "", "Trinidad & Tobago", "", "- : -"]],
					["#group-d-f",
						[field5, "November 4, 12:30", "Israel", "", "The Haroon Five", "", "- : -"],
						[field6, "November 4, 12:30", "Spoopy Soccer Players", "", "Mexico", "", "- : -"],
						[field1, "November 4, 1:00", "Israel", "", "Spoopy Soccer Players", "", "- : -"],
						[field2, "November 4, 1:00", "The Haroon Five", "", "Mexico", "", "- : -"],
						[field5, "November 4, 1:30", "Israel", "", "Mexico", "", "- : -"],
						[field5, "November 4, 2:00", "The Haroon Five", "", "Spoopy Soccer Players", "", "- : -"]],
					// ["#group-e-f",
